...
const config: SiteConfig = {
    site: {
        ...
        description:
            'Join us in celebrating our wedding in Newport, RI on June 24, 2027!',
    ...
    pages: [
        ...
        },
        {
            ...
            content: {
                title: 'Our Story',
                sections: [
                    <h1 className="title md:text-5xl/20 text-4xl/15 mt-5 mb-5">
                        Our Story
                    </h1>,

                    <p className="drop-cap mt-10 mb-5 text-lg text-left leading-6 md:text-xl mx-auto max-w-xl line-height-sm">
                        It all began in August 2019, when our love first took
                        flight. We were two freshmen at Saint Joseph's
                        University, arriving early for the Philadelphia Service
                        Immersion Program with no idea what was in store.
                    </p>,

                    <PictureFrame
                        lqip={IntroPic}
                        size="medium"
                        alt="Sammy and Jack at SJU"
                    />,

                    <p className="max-w-2xl mx-auto my-5 text-md md:text-lg leading-6">
                        As fate would have it, we were placed in the same group
                        and spent the week learning about Jesuit values and
                        painting walls around Philly. Over the weeks and months
                        that followed, we formed a special bond, first as
                        friends, and then something more as we navigated the ups
                        and downs of college life. On October 7, 2019, we
                    ...
                    <div className="flex flex-row flex-wrap justify-center gap-4 my-5">
                        <PictureFrame
                            lqip={PSIPGroupPic}
                            size="small"
                            alt="Sammy and Jack's first week at SJU"
                        />
                        <PictureFrame
                            lqip={CityHallPic}
                            size="small"
                            alt="Sammy and Jack at SJU basketball game"
                        />
                    </div>,

                    <p className="max-w-2xl mx-auto my-5 text-md md:text-lg leading-6">
                        Our four years at SJU brought a global pandemic,
                        long-distance stretches, RA life, and tough courses, but
                        it was the late-night Domino's runs, trips into the
                        city, and endless laughter that shaped a bond perfectly
                        meant for us.
                    </p>,
                    ...
                    <div className="flex flex-row flex-wrap justify-center gap-4 my-5">
                        <PictureFrame
                            lqip={HHPPic}
                            size="small"
                            alt="Sammy and Jack at an HHP event"
                        />
                        <PictureFrame
                            lqip={CongratsRA}
                            size="small"
                            alt="Sammy and Jack at the beach"
                        />
                        <PictureFrame
                            lqip={HawksGame}
                            size="small"
                            alt="Sammy and Jack in the city"
                        />
                    </div>,

                    <p className="max-w-2xl mx-auto my-5 text-md md:text-lg leading-6">
                        After graduating in Spring 2023, we moved to Bucks
                        County, PA to start our careers and welcomed Luna and
                        Leo into our little family.
                    </p>,
                    ...
                    <div className="flex flex-row flex-wrap justify-center gap-4 my-5">
                        <PictureFrame
                            lqip={GraduationPic}
                            size="small"
                            alt="Sammy and Jack Graduation"
                        />
                        <PictureFrame
                            lqip={MovingPic}
                            size="small"
                            alt="Sammy and Jack moving"
                        />
                        <PictureFrame
                            lqip={RabbitPic}
                            size="small"
                    ...
                    <p className="max-w-2xl mx-auto my-5 text-md md:text-lg leading-6">
                        When we're not working, you can usually find us playing
                        pickleball, cruising through the Caribbean, or hunting
                        down the best snacks.
                    </p>,
                    ...
                    <div className="flex flex-row flex-wrap justify-center gap-4 my-5">
                        <PictureFrame
                            lqip={VacationPic}
                            size="small"
                            alt="Sammy and Jack with Luna and Leo"
                        />
                        <PictureFrame
                            lqip={SurvivorPic}
                            size="small"
                            alt="Sammy and Jack on vacation"
                        />
                    </div>,

                    <p className="max-w-2xl mx-auto my-5 text-md md:text-lg leading-6">
                        On June 25, 2025, Jack proposed at sunset while we were
                        sailing through Newport Harbor.
                    </p>,

                    <PictureFrame
                        lqip={ProposalPic}
                        size="medium"
                        alt="Sammy and Jack's engagement"
                    />,

                    <p className="max-w-2xl mx-auto my-5 text-md md:text-lg leading-6">
                        As we approach our wedding day, we're endlessly grateful
                        for the family and friends who have supported us along
                        the way. We can't wait to celebrate with you in
                        beautiful Newport, RI. Here's to officially becoming
                        hawkmates!
                    </p>,
                ...
                members: [
                    {
                        ...
                        left: {
                            ...
                            image: Sammy,
                            funFact:
                                'Jack first met my Mom in palm tree swimtrunks in the middle of the winter! (He claims he had no clean laundry!)',
                        },
                        right: {
                            name: 'Jack',
                            role: 'The Groom',
                            image: Jack,
                            funFact:
                                'Sammy had her first drink in my freshman dorm room, a raspberry White Claw! (She called it a "raincloud in her head")',
                        },
                    },
                    {
                        role: 'The Parents',
                        left: {
                            ...
                            image: Beth,
                            funFact:
                                'I applied to Survivor and dream of being cast one day!',
                        },
                        right: {
                            name: 'Tom',
                    ...
                    },
                    {
                        ...
                        left: {
                            ...
                            image: Brenda,
                            funFact:
                                'My first date with Paul was a Rolling Stones concert at Foxboro Stadium, center stage, row #10.',
                        },
                        right: {
                            name: 'Paul',
                            ...
                            image: Paul,
                            funFact:
                                "After growing up playing hockey in a cold rink and later coaching my kid's teams, I now spend as much time as possible at the beach in Florida.",
                        },
                    },
                    {
                        ...
                        left: {
                            ...
                            image: JGRAY,
                            funFact:
                                "I've been to 100 concerts! (Some of which I organized at Penn State!)",
                        },
                        right: {
                            name: 'Peter',
                            role: 'Best Man',
                    ...
                    },
                    {
                        ...
                        right: {
                            ...
                            image: Bacon,
                            funFact:
                                'I played hockey at Worcester State as a goalie!',
                        },
                    },
                    {
                        role: 'Bridal Party & Groomsmen',
                        left: {
                            ...
                            image: Morgan,
                            funFact:
                                'I currently live in the Virgin Islands working as a dolphin trainer!',
                        },
                        right: {
                            name: 'Chris',
                            role: 'Groomsman',
                            image: Chris,
                            funFact:
                                'The Groom and I bonded over a very... crazy freshman roommate experience!',
                        },
                    },
                    {
                        role: 'Bridal Party & Groomsmen',
                        left: {
                            ...
                            image: Casey,
                            funFact:
                                'My favorite animal is a groundhog! I even went to Punxsutawney once to celebrate Groundhog Day!',
                        },
                        right: {
                            name: 'Tommy',
                            role: 'Groomsman',
                    ...
                    },
                    {
                        ...
                        left: {
                            ...
                            image: Bailey,
                            funFact:
                                'I play basketball for Gettysburg College!',
                        },
                        right: {
                            name: 'Harrison',
                            role: 'Groomsman',
                            image: Harrison,
                            funFact:
                                'I got a fist bump from Shaq during my high school graduation!',
                        },
                    },
                    {
                        role: 'Bridal Party & Groomsmen',
                        left: {
                            ...
                            image: Sara,
                            funFact:
                                'I played youth hockey with my twin brother! Go Bruins!',
                        },
                        right: {
                            name: 'Mystery',
                            role: 'Groomsman',
        ...
        },
        {
            ...
            content: [
                    ...
                    items: [
                        {
                            name: '22 Bowens',
                            description:
                                'Land and sea offerings in the heart of Newport. Sammy and Jack love the prime rib sandwich and chicken salads.',
                            image: Bowens,
                        ...
                        },
                        {
                            ...
                            description:
                                'Legendary lobster rolls and fresh seafood. Sammy and Jack visit here every time when in Newport.',
                            image: LobsterBar,
                        ...
                        },
                        {
                            ...
                            description:
                                'The classic pub experience in Newport with a wide menu. Sammy and Jack love the lobster mac and cheese. Great for large groups!',
                            image: BrickAlleyPub,
                        ...
                        },
                        {
                            ...
                            description:
                                'Some of the freshest seafood and oysters in Newport. Lobster rolls are great here, but Oysters are the star of the show!',
                            image: Midtown,
                        ...
                        },
                        {
                            ...
                            description:
                                'A charming spot with a cozy atmosphere and delicious New England fare. Known for its clam chowder and seafood dishes.',
                            image: ClakeCooke,
                    ...
                    items: [
                        {
                            name: 'Mansion Tours',
                            description:
                                'Take a tour through historic Gilded Age mansions including The Breakers, The Elms, Marble House, and more.',
                            image: TheBreakers,
                        ...
                        },
                        {
                            name: 'Cliff Walk',
                            description:
                                "A scenic walk along Newport's stunning coastline, passing by many of the famous mansions.",
                            image: CliffWalk,
                        ...
                        },
                        {
                            ...
                            description:
                                "Explore boutiques, galleries, and shops along Newport's main street.",
                            image: Thames,
                        ...
                        },
                        {
                            ...
                            description:
                                "Experience Newport's sailing heritage with a harbor tour or sailing excursion on Narragansett Bay. (Note: book in advance!)",
                            image: Sailing,
                        ...
                        },
                        {
                            ...
                            description:
                                'Enjoy stunning ocean views, picnicking, and kite flying at this beautiful state park located on the western tip of Newport. Food trucks are often visiting on weekends!',
                            image: BrentonPoint,
                        ...
                        },
                        {
                            ...
                            description:
                                'Explore Newport in a fun and thrilling mini beach buggy!',
                            image: Buggy,
                ...
                },
                {
                    ...
                    navIcon: BedIcon,
                    lodgingDescription:
                        'While OceanCliff does offer accomodations, they will be very limited and we encourage exploring the recommended options below. **Note: Book early, as Newport is a popular destination in the summer.**',
                    lodging: [
                        {
                            sectionId: 'newport-downtown',
                            title: 'Newport (Downtown)',
                            description:
                                "Staying here puts you right in the heart of the action with easy walkable access to shops, restaurants, and activities. It's about a 10-15 minute drive to OceanCliff. Most hotels offer parking, but be sure to check in advance.",
                            hotels: [
                                {
                                    name: 'Hammetts Hotel',
                        ...
                        },
                        {
                            ...
                            description:
                                "These neighboring towns offer a quieter stay while still close to Newport. It's a short drive to OceanCliff and downtown. Hotels in these areas are often more budget-friendly.",
                            hotels: [
                                {
                        ...
                        },
                        {
                            ...
                            hotels: [
                                {
                                    name: 'Weathervane Cottages',
                                    link: 'https://weathervanecottages.com/',
                                    description:
                                        'Located in Portsmouth, these cottages can comfortably sleep 2-5 guests (depending on room). While around a 35 minute drive to downtown Newport, they can provide a private, affordable stay. Avg $250/night.',
                                    address:
                                        '1172 West Main Road, Portsmouth, RI 02871',
                                    price: '$',
                                    image: WeathervaneCottages,
                                },
                                {
                                    name: 'East Island Reserve Hotel',
                                    link: 'https://www.eastislandreserve.com/',
                                    description:
                                        'Located in Middletown, these unique cottages comfortably sleep 2-6 guests (depending on room). Around a 20 minute drive to downtown Newport. Avg $300/night.',
                                    address:
                                        '985 East Main Road, Middletown, RI 02842',
                                    price: '$$',
                                    image: EastIslandHotel,
                                },
                            ],
                        },
                        {
                            ...
                            description:
                                'Additional lodging options can be found on Airbnb, VRBO, and other vacation rental platforms. This is a great option for larger groups or families who want to stay together. Be sure to book early, as Newport is a popular destination in June!',
                            hotels: [],
                        },
                    ],
                },
